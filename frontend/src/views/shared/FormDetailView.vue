        ...
        <div v-if="files.length > 0" class="space-y-2">
          ...
          >
            ...
            <div class="w-9 h-9 rounded-lg bg-ubpd-teal/10 flex items-center justify-center flex-shrink-0">
              ...
              <!-- Excel -->
              <svg v-else-if="file.tipo_mime === 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet'
                || file.tipo_mime === 'application/vnd.ms-excel'"
                class="w-5 h-5 text-emerald-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
